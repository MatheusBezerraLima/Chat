...
const colors = [
    "cadetblue",      // Verde-azulado suave
    "darkgoldenrod",  // Dourado escuro
    "cornflowerblue", // Azul claro
    "darkkhaki",      // Amarelo-acinzentado
    "hotpink",        // Rosa vivo
    "gold",           // Dourado
    "mediumseagreen", // Verde suave
    "slateblue",      // Azul-arroxeado
    "lightcoral",     // Coral claro
    "mediumaquamarine", // Verde aquático
    "orchid",         // Roxo suave
    "sandybrown"      // Marrom-alaranjado suave
];
...
const handleLogin = (event) =>{
    ...
    // Quando o servidor enviar uma mensagem executa a função
